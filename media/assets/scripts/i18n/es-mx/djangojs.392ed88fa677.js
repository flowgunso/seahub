...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(at least {passwordLength} characters)": "(al menos{passwordLength} caracteres)",
    ...
    "Allow user to add organization libraries. Otherwise, only system admin can add organization libraries.": "Permitir al usuario crear bibliotecas de la organizaci\u00f3n. De otra manera s\u00f3lo un administrador puede hacerlo.",
    ...
    "Email Notification of File Changes": "Email de notificaci\u00f3n de modificaciones de archivo",
    ...
    "Groups": "Grupos",
    "Groups allow multiple people to collaborate on libraries. Groups you join will be listed here.": "Los grupos permiten que varias personas colaboren en bibliotecas. Aqu\u00ed estar\u00e1n listados los grupos a los que pertenezcas.",
    "Groups allow multiple people to collaborate on libraries. You can create a group by clicking the \"New Group\" button.": "Los grupos permiten que varias personas colaboren en bibliotecas. Puedes crear un grupo haciendo click en el bot\u00f3n \"Nuevo Grupo\".",
    "Guest": "Invitado",
    "Handled": "Manejado",
    "Help": "Ayuda",
    "History": "Historial",
    ...
    "Public": "P\u00fablico",
    "Public libraries are for publishing your contents in an organized way.": "Las bibliotecas p\u00fablicas permiten publicar su contenido en una forma organizada.",
    "Publish": "Publicar",
    ...
    "Search libraries by name": "Buscar bibliotecas por nombre",
    ...
    "Start date should be earlier than end date.": "La fecha de inicio debe ser anterior a la de finalizaci\u00f3n.",
    ...
    "The least number of characters a download/upload link password should include.": "El m\u00ednimo n\u00famero de caracteres que deber\u00eda contener la contrase\u00f1a de un enlace de descarga/subida.",
    ...
    "Virus Scan Records": "Registros de An\u00e1lisis de Virus",
    "Visited": "Visitado",
    "Visits": "Visitas",
    ...
    "You are not in any groups": "No est\u00e1s en ning\u00fan grupo",
    ...
    "You do not have any public library": "No tienes ninguna biblioteca p\u00fablica",
    "You do not have connected devices": "No tienes dispositivos conectados",
    ...
    "You have not invited any people.": "No ha invitado a ninguna persona.",
    ...
    "Your clients (Desktop/Android/iOS) will be listed here.": "Tus clientes (Desktop/Android/iOS) ser\u00e1n listados aqu\u00ed.",
    ...
    "deleted": "eliminado",
    "details": "detalles",
    "download/upload link password minimum length": "m\u00edmima longitud de contrase\u00f1a de un enlace de descarga/subida",
    "draft": "borrador",
    ...
    "you can also press \u2192": "tambi\u00e9n puedes presionar \u2192 ",
    "{draft_link} has a new comment from user {author}.": "{draft_link} tuene un nuevo comentario del usuario {author}.",
